...
export const apiBuildDocsCode = {
    'basicBuild': `import { build } from '@absolutejs/absolute';
...
await build({
  ...
  tailwind: {
    ...
    'htmlOnlyBuild': `import { build } from '@absolutejs/absolute';
...
await build({
  ...
  htmxDirectory: './src/frontend/htmx'
    ...
    'frameworkBuild': `import { build } from '@absolutejs/absolute';
...
export { manifest };`,
    ...
    'assetFunction': `import { asset } from '@absolutejs/absolute';
...
app.get('/', () => {
  ...
  return new Response(
    ...
    'fullExample': `import { build, asset } from '@absolutejs/absolute';
...
console.log('Server running on http://localhost:3000');`,
    ...
    'allOptions': `import { build } from '@absolutejs/absolute';
await build({
