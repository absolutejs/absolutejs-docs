...
type TelemetryMobileSidebarProps = {
	spring: {
...
export const TelemetryMobileSidebar = ({
	spring,
	springApi,
	view,
	themeSprings,
				...
				<nav style={{ display: 'flex', flexDirection: 'column' }}>
					{telemetrySidebarData.map((element, index) => {
						...
						if (linkSprings === undefined) {
							throw new Error(
								'Internal index error in TelemetryMobileSidebar component'
							);
						}
