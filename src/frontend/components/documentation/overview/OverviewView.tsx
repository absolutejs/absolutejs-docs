		...
		>
			<div style={styles.mainContentStyle}>
				...
				<section style={styles.sectionStyle}>
					<animated.h2 style={styles.headingStyle(themeSprings)} id="why-absolutejs">
						Why AbsoluteJS?
					</animated.h2>
				...
				<section style={styles.sectionStyle}>
					<animated.h2 style={styles.headingStyle(themeSprings)} id="simple-example">
						Simple Example
					</animated.h2>
...
export type Server = typeof server;`}
				...
				<section style={styles.sectionStyle}>
					<animated.h2 style={styles.headingStyle(themeSprings)} id="key-features">
						Key Features
					</animated.h2>

					<section style={styles.sectionStyle}>
						<animated.h2 style={styles.headingStyle(themeSprings, true)} id="multi-framework-support">
					...
					<section style={styles.sectionStyle}>
						<animated.h2 style={styles.headingStyle(themeSprings, true)} id="built-in-authentication">
					...
					<section style={styles.sectionStyle}>
						<animated.h2 style={styles.headingStyle(themeSprings, true)} id="database-flexibility">
					...
					<section style={styles.sectionStyle}>
						<animated.h2 style={styles.headingStyle(themeSprings, true)} id="end-to-end-type-safety">
					...
					<section style={styles.sectionStyle}>
						<animated.h2 style={styles.headingStyle(themeSprings, true)} id="code-quality-built-in">
