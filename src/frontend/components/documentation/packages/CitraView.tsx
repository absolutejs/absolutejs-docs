...
import { mainContentStyle, h1Style, paragraphStyle, sectionStyle, headingStyle, paragraphLargeStyle, strongStyle, paragraphSpacedStyle, listItemStyle, listStyle} from '../../../styles/docsStyles';
