...
import { sectionStyle, headingStyle, paragraphSpacedStyle, listStyle, listItemStyle } from '../../../../styles/docsStyles';
import { startOAuthFlow, checkStatus, signout } from '../../../../data/authDocsCode';
		...
		<section style={sectionStyle}>
            ...
            <p style={paragraphSpacedStyle}>
                ...
                <ul style={listStyle}>
                    ...
                    <li style={listItemStyle}>building and redirecting to the provider's authorization URL</li>
                </ul>
            </p>
            <animated.h3
                style={headingStyle(themeSprings, true)}
            ...
            <p style={paragraphSpacedStyle}>
                ...
                <ul style={listStyle}>
                    <li style={listItemStyle}>runs your onSignOut hook (if provided)</li>
