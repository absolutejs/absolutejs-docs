			...
			<div style={mainContentStyle(isMobileOrTablet)}>
				<animated.div style={heroGradientStyle(themeSprings)}>
					...
					<p style={paragraphLargeStyle}>
						...
						request, its status, and how long it took, as it happens.
					</p>
				</animated.div>
				...
				<section style={sectionStyle}>
					...
					<p style={paragraphSpacedStyle}>
						...
						colored, and slow requests are highlighted so regressions
						jump out. Asset, HMR, and internal traffic is dimmed so
						your real page and API requests stand out, and the footer
						rolls up the request count plus average and p95 latency.
						It works by capturing every request through global
						lifecycle hooks on the dev runtime — no changes to your
						app required.
					</p>
					<PrismPlus
						codeString={inspectOutput}
						language="bash"
						showLineNumbers={false}
						themeSprings={themeSprings}
					/>
