	...
	>
		<animated.div style={heroGradientStyle(themeSprings)}>
			...
			<p style={paragraphLargeStyle}>
				Idiomatic bindings for React, Vue, Svelte, and Angular — all
				SSR-safe, all returning the same shape, so swapping frameworks
				in a multi-stack app doesn't change your data layer. There's a
				plain framework-agnostic client too.
			</p>
		</animated.div>
		...
		<section style={sectionStyle}>
			...
			<p style={paragraphSpacedStyle}>
				...
				<code>{'{ text, setText, status }'}</code>. The socket opens in
				an effect, re-opens if the subscription identity changes, and
				closes on unmount.
			</p>
			<PrismPlus
		...
		<section style={sectionStyle}>
			...
			<p style={paragraphSpacedStyle}>
				Composables returning reactive refs. SSR-safe — the socket opens
				in <code>onMounted</code> and closes in <code>onUnmounted</code>
				.
			</p>
			<PrismPlus
		...
		<section style={sectionStyle}>
			...
			<p style={paragraphSpacedStyle}>
				Real Svelte stores — <code>$store</code> gives the live state,
				with <code>mutate</code>/<code>setText</code>/
				<code>destroy</code> attached. Connection opens lazily on the
				first browser subscription.
			</p>
			<PrismPlus
		...
		<section style={sectionStyle}>
			...
			<p style={paragraphSpacedStyle}>
				...
				<code>collaborativeText</code> opens a CRDT field. The service
				closes everything on its own destroy.
			</p>
			<PrismPlus
		...
		<section style={sectionStyle}>
			...
			<p style={paragraphSpacedStyle}>
				...
				framework-agnostic client. Use it directly when you don't want a
				framework binding, or to build your own:
			</p>
			<PrismPlus
